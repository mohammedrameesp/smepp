...
describe('Asset Validation Schemas', () => {
  describe('createAssetSchema', () => {
    ...
    it('should require assignedUserId and assignmentDate when status is IN_USE', () => {
      const invalidAsset = {
        type: 'Laptop',
        model: 'MacBook Pro',
        status: AssetStatus.IN_USE,
        // Missing assignedUserId and assignmentDate
      };
    ...
    it('should pass when IN_USE status has assignedUserId and assignmentDate', () => {
      const validAsset = {
        type: 'Laptop',
        model: 'MacBook Pro',
        status: AssetStatus.IN_USE,
    ...
    it('should transform empty assignedUserId to null', () => {
      const asset = {
        type: 'Laptop',
        model: 'MacBook Pro',
        status: AssetStatus.SPARE,
  ...
  describe('assignAssetSchema', () => {
    it('should validate user ID assignment', () => {
      const assignment = {
        assignedUserId: 'user-123',
      };
    ...
    it('should fail without assignedUserId field', () => {
