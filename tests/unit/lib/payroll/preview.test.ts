...
describe('Payroll Preview', () => {
  ...
  describe('Single employee calculations', () => {
    ...
    it('should include employee identification details', async () => {
      ...
      const employee = result.employees[0];
      expect(employee.memberId).toBe('user-1');
      expect(employee.memberName).toBe('John Doe');
  ...
  describe('Multiple employees', () => {
      ...
      const mockSalaryStructures = [
        {
          ...
          otherAllowances: new Decimal(0),
          grossSalary: new Decimal(10000),
          member: { id: 'user-1', name: 'Alice', hrProfile: null },
        },
        {
          id: 'salary-2',
          memberId: 'user-2',
          ...
          otherAllowances: new Decimal(0),
          grossSalary: new Decimal(15000),
          member: { id: 'user-2', name: 'Bob', hrProfile: null },
        },
      ];
    ...
    it('should sort employees alphabetically by name', async () => {
      const mockSalaryStructures = [
        {
          ...
          otherAllowances: new Decimal(0),
          grossSalary: new Decimal(10000),
          member: { id: 'user-1', name: 'Zara', hrProfile: null },
        },
        {
          id: 'salary-2',
          memberId: 'user-2',
          ...
          member: { id: 'user-2', name: 'Alice', hrProfile: null },
        },
      ];
      ...
      expect(result.employees[0].memberName).toBe('Alice');
      expect(result.employees[1].memberName).toBe('Zara');
    });
  });
  ...
  describe('Edge cases', () => {
    it('should handle employee with null name', async () => {
      const mockSalaryStructure = {
        ...
        member: { id: 'user-1', name: null, hrProfile: null },
      };
      ...
      expect(result.employees[0].memberName).toBe('Unknown');
    });
    ...
    it('should handle employee without HR profile', async () => {
      const mockSalaryStructure = {
        ...
        otherAllowances: new Decimal(0),
        grossSalary: new Decimal(5000),
        member: { id: 'user-1', name: 'Test', hrProfile: null },
      };
      ...
      expect(result.employees[0].employeeCode).toBeNull();
