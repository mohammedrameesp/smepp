...
describe('Leave Deduction Calculations', () => {
  ...
  describe('calculateUnpaidLeaveDeductions', () => {
    describe('Basic deduction calculations', () => {
      it('should return empty array when no unpaid leaves', async () => {
        ...
        const result = await calculateUnpaidLeaveDeductions(userId, year, month, dailySalary, tenantId);
    ...
    describe('Rounding behavior', () => {
      it('should round deduction amount to 2 decimal places', async () => {
        ...
        const result = await calculateUnpaidLeaveDeductions(userId, year, month, oddDailySalary, tenantId);
  ...
  describe('getUnpaidLeaveDaysInPeriod', () => {
    it('should return 0 when no unpaid leaves', async () => {
      ...
      const result = await getUnpaidLeaveDaysInPeriod(userId, year, month, tenantId);
  ...
  describe('hasUnpaidLeaveInPeriod', () => {
    it('should return false when no unpaid leaves', async () => {
      ...
      const result = await hasUnpaidLeaveInPeriod(userId, year, month, tenantId);
  ...
  describe('Query filtering', () => {
    it('should filter by userId and tenantId', async () => {
      ...
      await calculateUnpaidLeaveDeductions(userId, year, month, dailySalary, tenantId);
  ...
  describe('Edge cases', () => {
    it('should handle February in leap year', async () => {
      ...
      const result = await calculateUnpaidLeaveDeductions(userId, 2024, 2, dailySalary, tenantId);
    ...
    it('should handle December to January spanning leave', async () => {
      ...
      const result = await calculateUnpaidLeaveDeductions(userId, 2024, 1, dailySalary, tenantId);
    ...
    it('should handle zero daily salary', async () => {
      ...
      const result = await calculateUnpaidLeaveDeductions(userId, year, month, 0, tenantId);
