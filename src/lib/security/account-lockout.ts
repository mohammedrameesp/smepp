...
// ═══════════════════════════════════════════════════════════════════════════════
// NOTE: TeamMember lockout functions removed in User-TeamMember consolidation
// All authentication (including lockout) is now handled through the User table
// TeamMember only contains org-level permissions and HR data
// ═══════════════════════════════════════════════════════════════════════════════
