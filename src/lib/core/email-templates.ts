...
export function assetUnassignedEmail(data: AssetUnassignedData): { subject: string; html: string; text: string } {
  const subject = `Asset Unassigned: ${data.assetTag} - ${data.assetBrand} ${data.assetModel}`;

  const html = emailWrapper(`
    <h2 style="color: #333333; margin: 0 0 20px 0; font-size: 20px;">Asset Unassignment Notification</h2>
    ...
    <p style="color: #555555; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
      The following asset has been unassigned from you by ${data.adminName}.
    </p>
...
- Asset Tag: ${data.assetTag}
- Asset Type: ${data.assetType}
- Brand / Model: ${data.assetBrand} ${data.assetModel}
