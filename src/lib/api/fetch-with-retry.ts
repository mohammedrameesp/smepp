...
/**
 * Parse API response and throw ApiError if not ok
 */
...
/**
 * Combined fetch with retry + response parsing
 */
 ...
 */
export const api = {
  get: <T>(url: string, options?: RetryOptions) =>
    apiFetch<T>(url, { method: 'GET' }, options),

  post: <T>(url: string, data?: unknown, options?: RetryOptions) =>
    apiFetch<T>(
      url,
      {
        method: 'POST',
  ...
  put: <T>(url: string, data?: unknown, options?: RetryOptions) =>
    apiFetch<T>(
      url,
      {
        method: 'PUT',
  ...
  patch: <T>(url: string, data?: unknown, options?: RetryOptions) =>
    apiFetch<T>(
      url,
      {
        method: 'PATCH',
  ...
  delete: <T>(url: string, options?: RetryOptions) =>
