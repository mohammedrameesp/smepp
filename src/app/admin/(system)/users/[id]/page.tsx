/**
 * @module app/admin/(system)/users/[id]/page
 * @description Redirect page for backwards compatibility. Routes /admin/users/[id]
 * to /admin/employees/[id]. This ensures old bookmarks and links continue to work
 * after the migration from users to employees module.
 */
import { redirect } from 'next/navigation';

/**
 * Props for the user detail redirect page.
 */
interface Props {
...
/**
 * Redirect page component for user detail view.
 * Extracts the user ID from params and redirects to the employees detail page.
...
## Overview
Dynamic redirect page that maintains backwards compatibility for the /admin/users/[id]
route by redirecting to /admin/employees/[id] with the same user ID.

## Functionality
- Extracts the user ID from the dynamic route parameter
- Redirects to the corresponding employees detail page
