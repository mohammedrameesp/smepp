        ...
        <div className="w-full max-w-md text-center">
          <div className="mb-8">
            <Link href="/" className="inline-flex items-center gap-2">
              ...
              <span className="text-slate-900 text-2xl font-bold">Durj</span>
            </Link>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
            ...
            <div className="space-y-3">
              ...
              <Link
                href="/"
                className="block w-full py-3 px-4 bg-slate-100 text-slate-700 rounded-xl font-medium hover:bg-slate-200 transition-colors"
              >
                Back to Home
              </Link>
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-slate-400 text-lg">
                Complete your account setup to join your organization and start collaborating with your team.
              </p>
            </div>
          </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            <Link href="/" className="inline-flex items-center gap-2">
              ...
              <span className="text-slate-900 text-xl font-bold">Durj</span>
            </Link>
          </div>
