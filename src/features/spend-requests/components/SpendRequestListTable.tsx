/**
 * @file SpendRequestListTable.tsx
 * @description Table component for listing and filtering spend requests with pagination
 * @module components/domains/projects/spend-requests
 */
'use client';
...
interface SpendRequestListTableProps {
  isAdmin?: boolean;
}

export function SpendRequestListTable({ isAdmin = false }: SpendRequestListTableProps) {
  ...
  const fetchRequests = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/spend-requests?${params}`);
      ...
      console.error('Error fetching spend requests:', error);
    } finally {
      setLoading(false);
    }
