 ...
 * @description Card component displaying detailed cost breakdown across subscription lifetime
 * @module components/domains/operations/subscriptions
 *
 * Features:
 * - Fetches and displays total cost across all active periods
 * - Shows period-by-period breakdown with dates and costs
 * - Handles multiple periods from cancellation/reactivation cycles
 * - Displays currency and billing cycle information
 * - Loading and error states
 * - Auto-updates when subscription changes
 *
 * Props:
 * @param subscriptionId - ID of subscription to analyze
 *
 * Usage:
 * ```tsx
 * <CostBreakdown subscriptionId="sub_xyz123" />
 * ```
 *
 * Display Logic:
 * - Each period shows: start date → end date (or "ongoing")
 * - Months/years in period calculated based on billing cycle
 * - Cost per period shown in subscription currency
 * - Total cost summed at top of card
 *
 * API: GET /api/subscriptions/[id]/cost
 */
'use client';
