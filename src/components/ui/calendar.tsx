  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: 'appearance-none bg-white border border-gray-200 rounded-md px-2 py-1 text-sm font-medium cursor-pointer hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-1',
        vhidden: 'sr-only',
      ...
      components={{
        IconLeft: () => <span className="h-4 w-4">&lsaquo;</span>,
        IconRight: () => <span className="h-4 w-4">&rsaquo;</span>,
      }}
      {...props}
    />
  );
